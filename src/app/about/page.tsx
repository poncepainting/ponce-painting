...
export default function AboutPage() {
  ...
  const companyValues = [
    ...
    {
      title: "Integrity",
      description: "We conduct our business with honesty, transparency, and ethical practices that build trust with our customers.",
      icon: "users"
    },
    {
      title: "Innovation",
      description: "We continuously seek new ideas and approaches to improve our services and deliver better solutions.",
      icon: "plus"
    }
  ];
          ...
          <AnimationWrapper type="slide-right" delay={0.2}>
            <div>
              ...
              <p className="text-gray-600 mb-4">
                This is a placeholder for your About page. Customize this page with your business's story,
                mission, vision, and team information.
              </p>
              
              <p className="text-gray-600 mb-4">
                Add your business's story here. Talk about how you started, your journey, and what makes
                your business unique. Share the challenges you've overcome and the milestones you've achieved.
              </p>
              
              <p className="text-gray-600">
                Highlight your expertise, experience, and what sets you apart from competitors. Tell your story
                in a way that connects with your audience and builds trust.
              </p>
            </div>
          </AnimationWrapper>
          ...
          <AnimationWrapper type="slide-up" delay={0.2}>
            <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 h-full">
              ...
              <p className="text-gray-600 mb-6">
                Describe your mission statement and core values here. What drives your business and what
                principles guide your operations?
              </p>
              
              <h3 className="text-xl font-bold mb-4 text-primary-800">Our Vision</h3>
              <p className="text-gray-600">
                Share your vision for the future. Where do you see your business going and what impact do you
                hope to make in your industry and community?
              </p>
            </div>
          </AnimationWrapper>
        </div>
        ...
        <AnimationWrapper type="slide-up" delay={0.2}>
          <div className="bg-white p-8 rounded-xl border border-gray-200 text-center">
            <p className="text-gray-600 mb-6">
              ...
              bring to your business. This section is perfect for showcasing the people behind your brand.
            </p>
            
            <div className="inline-flex items-center justify-center bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition-colors cursor-pointer">
              Meet Our Team
            </div>
          </div>
        </AnimationWrapper>
