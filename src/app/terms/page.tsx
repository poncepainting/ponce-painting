          ...
          <AnimationWrapper type="slide-up">
            <div className="prose prose-lg mx-auto bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
              ...
              <section className="mb-12">
                <h2>Introduction</h2>
                <p>
                  These Terms of Service ("<strong>Terms</strong>") govern your access to and use of the website, 
                  products, and services provided by {siteConfig.name} ("<strong>we</strong>", "<strong>our</strong>", 
                  or "<strong>us</strong>").
                </p>
                <p>
              ...
              <section className="mb-12">
                ...
                <h3>Eligibility</h3>
                <p>
                  By using our services, you represent and warrant that you are at least 18 years old or have the 
                  legal capacity to enter into binding contracts under applicable laws. If you are using our services 
              ...
              <section className="mb-12">
                ...
                <p>
                  Our services and all content included on or otherwise made available through our services, including 
                  but not limited to text, graphics, logos, images, software, and code (collectively, "<strong>Content</strong>"), 
                ...
                <p>
                  ...
                  non-sublicensable license to access and use our services for your personal or internal business purposes.
                </p>
              </section>
              ...
              <section className="mb-12">
                <h2>User Content</h2>
                <p>
                  Our services may allow you to upload, submit, store, send, or receive content ("<strong>User Content</strong>"). 
                  You retain ownership of any intellectual property rights that you hold in your User Content.
                </p>
                <p>
                  By submitting User Content to our services, you grant us a worldwide, royalty-free, perpetual, irrevocable, 
                  non-exclusive, transferable, and sublicensable license to use, reproduce, modify, adapt, publish, translate, 
                  create derivative works from, distribute, and display such User Content in connection with our services.
                </p>
                <p>
                  You represent and warrant that: (i) you own or have the necessary rights to your User Content; 
                  (ii) your User Content does not violate the rights of any third party; and (iii) your User Content 
                  complies with these Terms and all applicable laws and regulations.
                </p>
              </section>
              ...
              <section className="mb-12">
                ...
                <p>
                  ...
                  AND NON-INFRINGEMENT. WE MAKE NO WARRANTY THAT OUR SERVICES WILL MEET YOUR REQUIREMENTS OR BE AVAILABLE 
              ...
              <section className="mb-12">
                ...
                <p>
                  You agree to indemnify, defend, and hold harmless us and our officers, directors, employees, agents, 
                  and affiliates from and against any and all claims, liabilities, damages, losses, costs, expenses, 
                  or fees (including reasonable attorneys' fees) that arise from or relate to: (i) your use of our services; 
                  (ii) your violation of these Terms; (iii) your violation of any rights of another person or entity; 
                  or (iv) your User Content.
                </p>
              </section>
              ...
              <section className="mb-12">
                ...
                <p>
                  ...
                  updated Terms on our website or through other communications. Your continued use of our services after 
