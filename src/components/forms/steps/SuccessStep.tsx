  ...
  return (
    <div className="text-center py-4">
      ...
      <p className="text-gray-600 mb-6">
        Thank you for your request. We'll review your information and get back to you as soon as
        possible with a personalized quote.
      </p>

      <Button type="button" variant="primary" onClick={handleReset} size="lg" className="w-full">
        Start New Quote
      </Button>
    </div>
  );
