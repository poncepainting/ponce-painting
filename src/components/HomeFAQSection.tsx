    ...
    <div className={cn('w-full', className)}>
      ...
      <div className={`rounded-xl shadow-sm border p-6 mb-8 text-center ${colors.contactBg}`}>
        <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
          <div className={`rounded-full p-3 mb-4 shadow-sm ${colors.contactIconBg} ${colors.contactIconColor}`}>
            <Icon name="mail" size={28} />
          </div>
          <h3 className={`text-2xl font-bold mb-2 ${colors.contactTitle}`}>Have more questions?</h3>
          <p className={`mb-6 ${colors.contactText}`}>Our team is ready to help with any additional questions you might have.</p>
