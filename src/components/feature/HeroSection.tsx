...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section
      className={`relative flex items-center justify-center bg-dark-primary pt-5 md:pt-16 lg:pt-24 ${
        showQuoteForm ? 'min-h-screen pb-5 md:py-20' : heightClasses[height]
      }`}
    >
